...
import utils.data_utils.kitti_utils as kitti_utils
import utils.data_utils.kitti_oxts as kitti_oxts
...
class KittiSFdataset(Dataset):
    def __init__(self, data_root, npoints=16384, is_random=True, root = '', partition='train'):
